...
const CycleTimeMain: React.FC = () => {
  ...
  return (
    <CycleTimeUseContext.Provider value={{ formData, setFormData, setFormChange, formChange, activeTab, setActiveTab, isFormDisabled, setIsFormDisabled }}>
          ...
          <div className={styles.dataFieldBodyContentsBottom}>
            <div className={`${styles.commonTableContainer} ${isAdding ? styles.shrink : ''}`}>
              <CycleTimeBar
                ...
                button={
                  <InstructionModal title="Cycle Time Maintenance">
                    <UserInstructions />
                  </InstructionModal>
                } />
