...
const CycleTimeBar: React.FC<UserGroupBarProps> = ({ handleSearchClicks, handleGoClick, button }) => {
    ...
    <div className={styles.dataField}>
      <div className={styles.datafieldNav}>
        ...
        <div className={styles.goButton}> 
          <Button onClick={handleGoClicks} style={{marginRight:"10px"}} type='primary'>
            {t('go')}
          </Button>
          {button}
        </div>
