...
import {  retrieveAllActivity, retrieveTop50Activity } from "@services/dataTypeService";
...
interface DataTypeMaintenanceFormProps {
...
const DataTypeMaintenanceForm: React.FC<DataTypeMaintenanceFormProps> = ({
  onChange,
  rowData,
  setFormValues,
  resetValue,
  ...
  const { payloadData, setPayloadData, showAlert, setShowAlert, schemaData, setIsList } = useContext(DataTypeContext);
...
export default DataTypeMaintenanceForm;