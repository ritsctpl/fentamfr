...
const RadarChart: React.FC<RadarChartProps> = ({ data, title,description }) => {
    ...
    const valueKeys = data[0] ? Object.keys(data[0]).filter(key => typeof data[0][key] === 'number') : [];
        ...
        >
            {data.length === 0 ? (
               <NoDataFound />
                ...
                <>
                    <ReactECharts ref={echartsRef} option={option} style={{ height: 'calc(100vh - 305px)' }} />
                                        ...
                                        <>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
                                                <div style={{ 
                                                    width: '20px', 
                                                    height: '20px', 
                                                    backgroundColor: 'rgba(238, 197, 102, 0.86)', 
                                                    marginRight: '10px' 
                                                }}></div>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
                                                <div style={{ 
                                                    width: '20px', 
                                                    height: '20px', 
                                                    backgroundColor: 'rgba(238, 197, 102, 0.76)', 
                                                    marginRight: '10px' 
                                                }}></div>
