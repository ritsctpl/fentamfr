...
interface LiveOeeWorkcenterProps {
  setisSetShow: React.Dispatch<React.SetStateAction<boolean>>;
  ref:any;
}

const LiveOeeWorkcenter: React.FC<LiveOeeWorkcenterProps> = ({ setisSetShow,ref }) => {
  ...
  }, [selectedItem,setisSetShow]); // Trigger when `selectedItem` changes
