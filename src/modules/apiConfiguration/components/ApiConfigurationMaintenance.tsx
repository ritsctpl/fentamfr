...
import ApiConfigurationCommonBar from "./ApiConfigurationCommonBar";

import { parseCookies } from "nookies";
import { MyProvider, useMyContext } from "../hooks/apiConfigurationContext";
import ApiConfigurationMaintenanceBody from "./ApiConfigurationMaintenanceBody";
import { defaultFormData } from "../types/apiConfigurationTypes";
...
const ApiConfigMaintenance: React.FC = () => {
    ...
    <div className={styles.container}>
      <div className={styles.dataFieldNav}>
        <CommonAppBar
          ...
          username={username}
          site={null}
          appTitle={t("apiConfigMaintenance")} onSiteChange={function (newSite: string): void {
            setCall(call + 1);
          }} />
      </div>
...
export default ApiConfigMaintenance;
