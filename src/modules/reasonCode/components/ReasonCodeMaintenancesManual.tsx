    ...
    <div style={{ 
        ...
        <div style={{ 
            ...
            <h1 style={{ 
                ...
                fontWeight: 'bold', 
                margin: '0 0 5px 0' 
            }}>Reason CodeMaintenance Instructions</h1> 
        ...
        <div style={{ marginBottom: '25px' }}>
            ...
            <p><strong>Purpose:</strong> To guide users on how to use the Reason Code Maintenance Maintenance Screen for logging, updating, and tracking maintenance activities.</p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px', border: '1px solid #000' }}>
                <tbody>
                    <tr>
                        ...
                        <td style={{ border: '1px solid #000', padding: '8px' }}>/rits/reasonCode_app</td>
                    </tr>
                    <tr>
        ...
        <div style={{ marginBottom: '25px' }}>
            ...
            <p>Main Menu &gt; Reason CodeMaintenance &gt; Maintenance Entry/Tracking</p>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px', border: '1px solid #000' }}>
                <tbody>
                    <tr>
                        ...
                        <td style={{ border: '1px solid #000', padding: '8px' }}>Filters by Reason Code</td>
                    </tr>
                    <tr>
                        <td style={{ border: '1px solid #000', padding: '8px' }}>Maintenance Table</td>
                        <td style={{ border: '1px solid #000', padding: '8px' }}>Lists past maintenance records (columns like ID, Reason Code, Date)</td>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style={{ border: '1px solid #000', padding: '8px' }}>
                            • Reason Code <span style={{ color: 'red' }}>*</span><br />
                            • Description <br />
                    ...
                    <tr>
                        <td style={{ border: '1px solid #000', padding: '8px' }}>Step 3: Custom Data Tab</td>
                        <td style={{ border: '1px solid #000', padding: '8px' }}>
                            • Custom Data <br />
                            • Value <span style={{ color: 'red' }}>*</span><br />
                        </td>
                    </tr>
        ...
        <div style={{ marginBottom: '25px' }}> 
            ...
            <table style={{ 
                ...
                <tbody> 
                    {[ 
                        ['Reason Code', 'Unique identifier for the reason code', 'Yes'],
                        ['Description', 'Detailed description of the reason code', 'Yes'],
                        ['Category', 'Category classification of the reason code', 'Yes'],
                        ['Type', 'Type classification of the reason code', 'Yes'],
                        ['Resource', 'Associated resource or equipment', 'No'],
                        ['Status', 'Current status of the reason code', 'Yes'],
                        ['Message Type', 'Type of message associated with the reason code', 'No']
                    ].map((row, index) => ( 
                        <tr key={index}> 
...
export default ReasonCodeManual;