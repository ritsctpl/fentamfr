...
const ToolNumberCustomData: React.FC = () => {
  const {formData, setFormData} = useContext<any>(ToolNumberContext)
  ...
  useEffect(() => {
    const fetchCommonData = async () => {
      ...
      try {
        ...
        const response = await retrieveCustomDataList(site, 'Tool Number', userId);
...
export default ToolNumberCustomData;
