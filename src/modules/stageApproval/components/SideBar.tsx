...
function SideBar({ filter, setFilter }: { filter: boolean, setFilter: (filter: boolean) => void }) {
    ...
    const documents: DocumentItem[] = [
        { id: '0001-BMR', title: 'BMR-Doc-001', status: 'Completed' },
        { id: '0002-BMR', title: 'BMR-Doc-002', status: 'Pending' },
        { id: '0003-BMR', title: 'BMR-Doc-003', status: 'Ongoing' },
        { id: '0004-BMR', title: 'BMR-Doc-004', status: 'Completed' },
        { id: '0005-BMR', title: 'BMR-Doc-005', status: 'Pending' },
    ];
