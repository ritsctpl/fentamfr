...
const NoDataScreen: React.FC<NoDataScreenProps> = ({
  ...
  subMessage = "There is no data to display",
}) => {
  return (
    <div className="no-data-container">
      <div className="no-data-content">
        ...
        <p className="no-data-title" style={{ fontSize: '16px' }}>{message}</p>
        <p className="no-data-subtitle" style={{ fontSize: '14px' }}>{subMessage}</p>
      </div>
    </div>
  );
};
