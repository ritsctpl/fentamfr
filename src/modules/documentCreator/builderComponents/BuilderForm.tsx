...
const BuilderForm: React.FC<any> = ({ isEditable = true, props }) => {
    const { title, data, onChange, type, metaData, componentId, section = 'main' } = props;
    ...
    const handleSave = async () => {
        try {
            ...
            // Update the component's data in the correct section
            currentTemplate.components[section][componentIndex].config.data = formattedData;
