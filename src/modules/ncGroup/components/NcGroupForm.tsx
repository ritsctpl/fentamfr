...
interface NcGroupMaintenanceFormProps {
...
const NcGroupForm: React.FC<NcGroupMaintenanceFormProps> = ({
  onChange,
  layout = 'horizontal',
  labelCol = { span: 8 },
  wrapperCol = { span: 12 },
  ...
  const { payloadData, setPayloadData, schemaData, addClickCount, mainSchema, showAlert, setShowAlert } = useContext<any>(NcGroupContext);
