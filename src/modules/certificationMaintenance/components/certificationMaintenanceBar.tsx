...
interface certificationMaintenanceBarProps {
  handleTop50: (searchTerm: string) => void;
  handleSearchClicks: (searchTerm: string) => void;
}

  const CertificationMaintenanceBar: React.FC<certificationMaintenanceBarProps> = ({ handleTop50, handleSearchClicks }) => {
...
export default CertificationMaintenanceBar;
