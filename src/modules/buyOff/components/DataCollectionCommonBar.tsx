...
import { fetchBuyOffTop50 } from '@services/buyOffService';
...
const RoutingCommonBar: React.FC<RoutingCommonBarProps> = ({ onSearch, setFilteredData, button }) => {
  ...
  const handleItemFetch = () => {
    const fetchItemData = async () => {
      ...
      try {
        itemTop50List = await fetchBuyOffTop50(site);
