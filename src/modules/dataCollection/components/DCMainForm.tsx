...
const DynamicForm: React.FC<DynamicFormProps> = ({
  ...
  const { payloadData, setPayloadData, schema, setShowAlert, rowSelectedData, setRowSelectedData } = useContext<any>(DataCollectionContext);
  ...
  return (
    <>
      ...
      <Form
        ...
        style={{
          // width: '100%',
          // maxHeight: 'calc(100vh - 100px)', // Limit the form height
          // overflowY: 'auto',
          marginTop: '2%',
        }}
      >
