...
export const defaultPodConfig: PodConfig = {
  ...
  settings: {
    ...
    "buttonActivityInWork": null,
    "buttonActivityInQueue": null
  },
  layout: []
};
...
export const workListPanel = {
  content: 'WorkListPanel',
  buttonLabel: 'WorkListPanel',
  buttonId: 'WorkListPanel',
  pluginLocation: 1,
  url: '/rits/workListPanel',
}
